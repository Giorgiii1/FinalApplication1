            ...
            mAuth!!.createUserWithEmailAndPassword(
                ...
                if (!task.isSuccessful) {
                    ...
                    if (mPassword.length < 6) {
                        mTextInputLayoutRegisterPassword.isErrorEnabled = true
                        mTextInputEditTextRegisterPassword.error = "Password too short,enter minimum 6 characters"
                    } else {
                        Toast.makeText(
                            this@RegisterActivity,
                            "Authentification failed,check your email",
                            Toast.LENGTH_LONG
                        ).show()
                    }
                } else {
